    ...
    <div class="card mx-auto mb-3">
        ...
        <div class="card-body">
            ...
            <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#approved" role="tab">Approved Replacements</a>
                    </li>

                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#pending" role="tab">Pending Replacements</a>
                    </li>
            </ul>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane active pt-3" id="approved" role="tabpanel">
            ...
            <div  class="row mt-3">
                ...
                <div class="tab-pane pt-3" id="pending" role="tabpanel">
