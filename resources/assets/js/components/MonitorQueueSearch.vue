        ...
        <div class="row mt-3">
            ...
            <div class="modal-dialog" id="queueter">
                ...
                <div class="modal-footer">  
                    <form  method="POST" :action="'/driver_rfid/public/storeCurrentlyServing/'+ queue.driver_id + '/' + queue_id">
...
<script>
    ...
    export default {
        ...
        props: ['queue_id','searchString','date'],
        ...
        methods: {
            getEntries() {
                this.loading = true
                axios.get('/driver_rfid/public/searchQueueEntries/' + this.queue_id + '?search_date=' + this.date)
                .then(response => {
